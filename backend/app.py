...
# BD = Country(id=20, name="Bangladesh", alias="BD")
...
# SI = Country(id=194, name="Slovenia", alias="SI")
...
# SN = Country(id=199, name="Senegal", alias="SN")
# SO = Country(id=200, name="Somalia", alias="SO")
